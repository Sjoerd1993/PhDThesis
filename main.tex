...
\makeatletter
\def\input@path{{figures_pdftex}}
\makeatother
\graphicspath{{figures_pdftex}}
...
fitpaper=True
	...
	\include{sections/sammanfattning}
	\include{sections/preface}
	\include{sections/includedpapers}    
	\cleardoublepage
	...
	\include{sections/scatteringtheory}
	\include{sections/multilayeroptics}
	\include{sections/offspecular}    
	\include{sections/multilayerdepositions}
	\include{sections/instrumentalaspects}
	\include{sections/reflectivitysimulations}
	\include{sections/Multilayercharacterization}
	\include{sections/SummaryResults}
	\include{sections/Outlook}
	\include{sections/SummaryPapers}
